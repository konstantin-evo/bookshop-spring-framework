            ...
            return {
                init: function () {
                    ...
                    $input.on('blur', function () {
                        ...
                        const userLocale = new URLSearchParams(window.location.search).get("lang");
                        if (validate) {
                                ...
                                switch (v) {
                                    ...
                                    case'mail':
                                        if ($this.val() !== '' && !$this.val().match(/\w+@\w+\.\w+/) && !$this.prop('disabled')) {
                                            userLocale === "ru"
                                                ? message += 'Введите адрес почты в формате xxx@xxx.xx'
                                                : message += 'Enter your e-mail address in the format xxx@xxx.xx';
                                            error = true;
                                        }
                                        break;
                                    case'key':
                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            };getData('/api/search/' + $this.find('.search-input').val(), {
                                offset: 0,
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/api/books/author/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'tag':
                                getData('/api/books/tags/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'search':
                                getData('/api/search/' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', oldOffset + $this.data('refreshlimit'));
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/api/rate-book-review', data, function (result) {
                ...
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">SMS code is hardcode and equal to "123 123"</div>')
                    ...
                    $('#submitMail').on('click', function () {
                        ...
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">A confirmation code has been sent to you by email</div>')
                                $this.attr('disabled', 'disabled');
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                            } else {
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    $but.after('<div class="form-info">Code successfully verified</div>');
                                    $this.trigger('change');
                                } else {
                                    if (result) {
                                        ...
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div class="form-error">' + 'Wrong code or phone number!' + '</div>');
                                    } else {
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'User not found or invalid code entered' + '</div>');
                                        }
                                    }
                                })
                            } else {
            ...
            return {
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'KEPT') {
                            Login().postData('/books/changeBookStatus/kept/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if ($this.is('[data-btntype="check"]')) {
                        ...
                        if ($this.data('sendstatus') === 'CART') {
                            Login().postData('/books/changeBookStatus/buy/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if ($this.is('[data-btntype="check"]')) {
                        ...
                        if ($this.data('sendstatus') === 'UNLINK-CART') {
                            Login().postData('/books/changeBookStatus/cart/remove/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if ($this.is('[data-btntype="check"]')) {
                        ...
                        if ($this.data('sendstatus') === 'UNLINK-KEPT') {
                            Login().postData('/books/changeBookStatus/postpone/remove/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if ($this.is('[data-btntype="check"]')) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        var $this = $(this), check = $this.prop('checked'), dataBook = {};
                        dataBook.bookId = $this.closest('.Rating').data('bookid');
                        dataBook.value = (check ? $this.val() : 0);
                        Login().postData('/api/rate-book', dataBook, function (result) {
